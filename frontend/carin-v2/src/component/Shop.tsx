...
// import {buyAntigen} from './Maingame'
...
const Shop = ({costA,costB,costC}:any) =>{
    return(
        <div className='shop flex flex-col'>
                    ...
                    <button ><img className='my-0.7' src={antibodyA} height={100} width={100} onClick = {()=>{}}/></button>
                        <p>{costA} $</p>
                    </p>

                    <p className='antibody-text slot-shop antibody-set font-Righteous'>antibody B
                    <button ><img className='my-0.7' src={antibodyB} height={100} width={100} onClick = {()=>{}}/></button>
                        <p>{costB} $</p>
                    </p>

                    <p className='antibody-text slot-shop antibody-set font-Righteous'>antibody C
                    <button><img className='my-0.7' src={antibodyC} height={100} width={100} onClick = {()=>{}}/></button>
                        <p>{costC} $</p>
                    </p>
                </div>
    )
...
function buyAntigen(arg0: string) {
